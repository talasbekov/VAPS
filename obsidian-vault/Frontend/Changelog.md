...
- 2026-08-21 `6eae7142` feat(traffic): экран «Расход и светофор» (/security-ops/traffic) — светофор сдачи по дереву, версии сдач с XLSX, выпуски, блокировка завтра с законным обходом; e2e traffic-control.spec.ts (4, красная проба), маршрут в карте смоука; merge main `9e1dc8e2` (ГВО-коммиты параллельной сессии). Ночная сессия, см. [[../WIKI/plans/Ночная-сессия-2026-08-20|план]]
- 2026-08-21 `62d00d4a` fix(dark): контраст 4.5:1 для 12 пар сырых Tailwind-цветов без -ink токена — StatCard, OrgBoard, /organization, /employees, command-center, profile, /security-ops/traffic; headless-скан + красная проба (ночная сессия)
