...
export const UNAVAILABLE_DETECTORS = [
  {
    ...
    reason:
      'Пороги нагрузки теперь живут в «Настройках» (LOAD_POLICY), и блок «Нагрузка» считается по ним, — но наблюдение §22.11 требует СВОЕГО детектора со своей политикой внимания и формулировкой словаря. Такого детектора нет; дублировать сюда состояние блока значило бы выдать перестановку показателя за наблюдение.',
  },
  {
