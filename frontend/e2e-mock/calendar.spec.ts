...
// дежурства сидированы на businessDate() старта (2026-07-20), расстановка ОМ
// «Международный экономический форум» — на daysFromStart=2 (2026-07-22).
// Проверяет: дефолтный день показывает дежурства, навигация вперёд на 2 дня
// показывает расстановку ОМ со ссылкой на карточку мероприятия.
