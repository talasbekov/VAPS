...
const DEFINITIONS: DictionaryDefinition[] = [
  ...
  // Роли наряда (Plane №237) — мок отстал от сервера и жил без них: экран
  // расстановки на моке не видел ни одной роли, и «ролей нет» читалось как
  // состояние системы, а не как дыра в моке. Дописано вместе с №274.
  {
    code: "PLACEMENT_ROLES",
    label: "Роли наряда в расстановке",
    description:
      "Кем человек идёт в наряде: водитель VIP, ответственный за кортеж, начальник выездной охраны и прочие места бланка «Общая расстановка».",
  },
  // Виды участия в ОМ и роли внутри группы (Plane №274, Ш-2).
  {
    ...
    description:
      "Чем человек занят на мероприятии: физический наряд либо специфическая группа (досмотра, кинологическая и прочие).",
  },
  {
    code: "EVENT_GROUP_ROLES",
    label: "Роли внутри группы",
    description:
      "Кем человек идёт в группе: досмотрщик, кинолог и прочие. Роль принадлежит КОНКРЕТНОЙ группе — она указывается в поле группы.",
  },
];
