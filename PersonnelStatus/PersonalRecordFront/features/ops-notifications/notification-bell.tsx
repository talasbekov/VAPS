  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex flex-col items-end gap-2">
      ...
      {/* Счётчик менялся молча: цифра на иконке не объявляется. Живой регион
          ...
          Без role="status": этот колокольчик живёт в лэйауте раздела, и роль
          сделала бы его «сообщением страницы» на каждом экране ОМ — а такие
          сообщения на экранах свои. aria-live для объявления достаточно. */}
