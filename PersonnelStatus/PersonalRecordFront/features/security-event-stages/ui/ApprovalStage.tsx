    ...
    <Card role="region" aria-label="Согласование расстановки">
      ...
      <CardContent className="space-y-4">
        ...
        {/* `[СОГ-11]` (Plane №399): здесь НЕТ блока «Обходы предупреждений»
            ...
            🔴 Оговорка «число обходов остаётся плиткой сводки» СНЯТА (Plane
            №720): плитку убрал тот же коммит, что и блок (№446), и
            утверждение пережило то, что описывало. Про обходы на этом экране
            не остаётся ничего — и это осознанно. */}
