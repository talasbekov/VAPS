 ...
 * - `duties` сюда НЕ входит — страница `/security-ops/duties/` удалена
 *   13.08.2026 (см. components/navigation/sidebar.tsx:186), жив только
 *   `/security-ops/duties/combat/`. Если бы `duties` маппился на подпись,
 *   крошка вела бы на несуществующий /security-ops/duties/ — 404.
 ...
 * - `forces` на странице — «Сбор сил на ОМ».
...
const SEGMENT_LABELS: Record<string, string> = {
  ...
  combat: "Боевые группы",
  "daily-expense": "Расход дня",
