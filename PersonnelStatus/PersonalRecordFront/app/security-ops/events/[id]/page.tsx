        ...
        <CardContent className="p-4">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            ...
            {/* Функционал модуля «Реестр ГВО» переехал сюда (Plane «Реестр
                ...
                Кнопка — только там, где сводке ГВО есть чем быть (Plane
                «Реестр ОМ-35.5»): у ВНУТРЕННЕГО мероприятия выездной охраны
                нет, и кнопка обещала бы пустоту. `kind === null` — ОМ заведено
                до появления типа: тип не назван, и скрывать по незнанию
                нельзя — у таких мероприятий сводка может быть заполнена, а
                после снятия модуля («ОМ-35.8») другого входа в неё не
                останется. */}
            {event.kind !== "INTERNAL" && (
            <Button
              type="button"
