...
ROLE_PERMISSIONS = {
    ...
    "HEAD_OPS_UNIT": [
        ...
        "placement.manage", "placement.command", "gvo.manage",
        # Перевод ОМ на любой этап (`[РЕК-03]`: «„Перевести ОМ сюда“ — только
        # штаб и админ», Plane №442). До этого право не носил никто, и кнопку
        # мог нажать один админ.
