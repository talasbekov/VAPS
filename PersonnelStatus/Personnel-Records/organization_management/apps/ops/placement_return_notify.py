...
два возврата одного объекта в один день дадут старшему ОДНО уведомление с
payload первого. Это принято: второй возврат он увидит на самой карточке
(баннер и замечания над деревом, №397), а лента не превратится в дубли.
