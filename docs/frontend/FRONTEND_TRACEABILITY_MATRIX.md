...
| Настройки: пороги показателей §22.5 (периоды, предел выгрузки, хранение) | — | — | Not started (лежат в СВОИХ слайсах service-analytics/service-reports; перенос затронет обе фичи целиком) |
