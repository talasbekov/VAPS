...
## NEXT ACTION
`e2e-mock/` теперь покрывает ВЕСЬ жизненный цикл ОМ (Этапы 11-12) + personnel/objects/dictionaries/calendar. Осталось: audit, analytics, duties — только ручная QA; либо продолжить функциональный объём (уведомления/боевые группы/оперативный профиль) по решению пользователя.
