...
| План дежурств на месяц (сетка «объект × день», серверные KPI §21.29, конфликты §21.34) | duties (вкладка «Месяц») | features/duties | getMonthlyPlan | e2e-mock/duty-monthly-plan.spec.ts | Verified (lifecycle плана DRAFT→APPROVED — Not started, см. A63) |
