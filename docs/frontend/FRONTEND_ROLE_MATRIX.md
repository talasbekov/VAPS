...
|---|---|---|---|---|
| event_planner | Организатор ОМ (штаб) | ops.dashboard.view, ops.security_event.view, ops.security_event.create, ops.bulletin.manage, ops.demand.manage, ops.placement.manage, ops.acknowledgement.manage, ops.conduct.manage, ops.closure.manage, ops.dictionary.view | своё управление | — |
| recon_officer | Офицер рекогносцировки | ops.security_event.view, ops.recon.manage, ops.dictionary.view | назначенные ОМ | — |
...
| objects_admin | Ведение объектов/паспортов/дежурств/справочников | ops.object.view, ops.object.manage, ops.passport.publish, ops.duty.view, ops.duty.manage, ops.dictionary.view, ops.dictionary.manage | свои объекты | — |
| analyst | Аналитика/дашборды/экспорт | ops.analytics.view, ops.export.run, ops.dictionary.view | по scope должности | — |
