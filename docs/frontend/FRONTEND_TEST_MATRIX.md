...
## NEXT ACTION
E2E теперь покрывает ВЕСЬ жизненный цикл ОМ (все 9 стадий, 4 спеки), personnel, objects, dictionaries, calendar, audit, analytics, duties — 11 спек, ноль экранов без хотя бы одного e2e-прохода. Оставшиеся Not started пункты (боевые группы, месячное планирование дежурств, уведомления, оперативный профиль, tablet/Firefox) — не экраны с существующей реализацией, а нереализованный функционал; решение о следующем направлении — за пользователем.
