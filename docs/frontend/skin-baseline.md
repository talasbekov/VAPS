...
(Note: бриф Task 0 ссылался на SHA `766638ca`, которого в истории ветки нет —
похоже, бриф писался до последнего ребейза/коммита плана. Фактический HEAD
worktree на момент прогона — `a383bdd8`, тот же, что и в
