...
## Ревью пользователя
2026-07-04: Bratan просмотрел `.review.html` целиком и одобрил без замечаний («в таком стиле можешь
делать») — стиль превью (русский контент, домен кадрового учёта, статусная палитра донора) утверждён
как базлайн. Будущие превью авторить в том же стиле; ре-ревью нужно только на новые/изменённые карточки.
