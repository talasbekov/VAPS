 ...
 * - `service-reports` H1 (Plane №985, [ОТЧ-ОМ-01]) переименован в «Отчёты по
 *   ОМ» — то же имя, что в сайдбаре и заголовке экрана; было «Отчёты
 *   службы», расходилось с меню.
