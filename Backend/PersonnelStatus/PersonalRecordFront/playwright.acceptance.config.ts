...
export default defineConfig(smoke, {
  ...
  testMatch: ['forces-workspace.spec.ts', 'role-driven-acceptance.spec.ts', 'placement-rights-rules.spec.ts', 'placement-stage.spec.ts', 'auto-placement-reconcile.spec.ts', 'collection-physical-shortage.spec.ts', 'smoke-preserve-data.spec.ts'],
