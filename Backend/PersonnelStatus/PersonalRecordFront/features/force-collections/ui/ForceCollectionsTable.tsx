 ...
 *
 * ОТКЛОНЕНИЕ ОТ ЭТАЛОНА, то же что и в №272. На эталоне колонка называется
 * «Срок сбора» — поля срока в модели нет ВООБЩЕ (карточка Plane №287).
 * Колонка показывает дату самого мероприятия и называется «Дата ОМ»: выдать
 * её за срок значило бы нарисовать правило, которого система не проверяет.
 *
