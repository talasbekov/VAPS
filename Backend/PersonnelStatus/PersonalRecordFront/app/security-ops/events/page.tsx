 ...
 *
 * В карточку по-прежнему ведут ДВЕ ссылки, и обе — настоящие `<a>`: код с
 * названием мероприятия и стрелка «›» в конце строки. Ссылка открывается в
 * новой вкладке средней кнопкой и видна скринридеру списком ссылок — клик по
 * строке ни того, ни другого не даёт, и заменять их им нельзя.
 *
