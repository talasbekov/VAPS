// MSW-handlers нормативной базы ОМ. Своего бэкенда у справочника нет вовсе
// (см. lib/api-gaps.ts), поэтому handlers регистрируются безусловно, без
// пер-доменного live-переключателя.
//
