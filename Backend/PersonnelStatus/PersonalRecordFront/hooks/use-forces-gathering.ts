...
//
// 🔴 СЛИЯНИЕ (Plane №486): двух кодов больше нет — цепочка пишет `IN_EVENT`, а
// «наряд или группа» живёт в `participations[].kind_code`. Разрезу вид не
// нужен, ему нужен факт занятости, поэтому здесь один код. Старые два
// остаются у читателей расхода (`strength_report.EVENT_INVOLVEMENT_CODES`)
// ради строк, не прошедших миграцию.
export const EVENT_ASSIGNMENT_CODE = "IN_EVENT";
