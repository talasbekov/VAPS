...
// Горизонтальный степпер жизненного цикла ОМ. Шагов ШЕСТЬ — как в прототипе
// Smart Josparlau; девять стадий бэкенда отображаются на них (см. EVENT_STEPS
// в entities/security-event: «Потребность» и «Запрос сил» свёрнуты в
// «Расстановку», «Проведение» — в «Закрытие»).
//
