...
export default defineConfig({
  ...
  testMatch: ['service-employees.spec.ts', 'main-om-walkthrough.spec.ts', 'main-daily-expense-walkthrough.spec.ts', 'objects-tabs.spec.ts', 'gvo-sections.spec.ts', 'protected-persons.spec.ts', 'legal-documents.spec.ts', 'vehicles-registry.spec.ts', 'placement-stage.spec.ts', 'closure-stage.spec.ts', 'visit-object-close.spec.ts', 'conduct-evaluations.spec.ts', 'acknowledgement-stage.spec.ts', 'approval-stage.spec.ts', 'recon-stage.spec.ts', 'bulletin-stage.spec.ts', 'command-center.spec.ts', 'stage-chain.spec.ts', 'stage-override.spec.ts', 'events-registry.spec.ts', 'operations-analytics.spec.ts', 'service-analytics.spec.ts', 'my-profile.spec.ts', 'object-passport.spec.ts', 'forms-validation.spec.ts', 'tables-data.spec.ts', 'org-structure-status.spec.ts', 'org-structure-view.spec.ts', 'prototype-skin.spec.ts', 'dashboard-metrics.spec.ts', 'lagging-reminders.spec.ts', 'forces-gathering.spec.ts', 'daily-expense.spec.ts', 'daily-business-date.spec.ts', 'department-summary.spec.ts', 'day-submission.spec.ts', 'hydration.spec.ts', 'auth-logout.spec.ts', 'mock-contract.spec.ts', 'access-permissions.spec.ts', 'access-roles.spec.ts', 'access-users.spec.ts', 'access-accounts.spec.ts', 'change-password.spec.ts', 'employee-status-actions.spec.ts', 'status-set-dialog.spec.ts', 'department-requests.spec.ts', 'force-collections.spec.ts', 'module-tabs.spec.ts', 'status-calendar.spec.ts', 'status-vacancy-actions.spec.ts', 'status-dialog-calendar-locale.spec.ts', 'status-event-link.spec.ts', 'allocation-due-at.spec.ts', 'route-map-coverage.spec.ts', 'ru-plural.spec.ts', 'notifications-feed.spec.ts', 'bulletin-person-details.spec.ts', 'session-refresh.spec.ts', 'directorate-denial.spec.ts', 'reports-strength-path.spec.ts', 'expense-section-role.spec.ts', 'dashboard-unlinked-account.spec.ts', 'session-fetch-storm.spec.ts', 'status-catalog-source.spec.ts', 'status-catalog-label.spec.ts', 'status-portal-participation.spec.ts', 'access-matrix-menu.spec.ts', 'status-types-dictionary.spec.ts', 'menu-access.spec.ts', 'identity-without-portal-role.spec.ts', 'access-multi-role.spec.ts', 'table-column-headers.spec.ts', 'forces-batch-requests.spec.ts', 'employees-read-access.spec.ts', 'approval-rights.spec.ts', 'in-development-badge.spec.ts', 'in-development-registry.spec.ts', 'approval-remarks-shape.spec.ts', 'staff-rights.spec.ts', 'ui-access-rule.spec.ts', 'bulletin-issues.spec.ts', 'placement-pool.spec.ts', 'approval-print.spec.ts', 'approval-route.spec.ts', 'approval-return.spec.ts', 'visit-page.spec.ts', 'geo-dictionaries.spec.ts', 'create-event-required.spec.ts', 'forces-request-banner-from-menu.spec.ts', 'department-request-notified-at.spec.ts', 'department-answer-draft.spec.ts', 'react-list-keys.spec.ts', 'ru-plural-single-rule.spec.ts', 'visit-scope-unassigned.spec.ts', 'gvo-unspecified-flags.spec.ts', 'right-hint-pattern.spec.ts', 'own-fixture-pattern.spec.ts', 'ops-pagination-param.spec.ts', 'mock-route-templates.spec.ts', 'force-handover-moment.spec.ts', 'approval-rights-rules.spec.ts', 'settings-unseeded-section.spec.ts', 'visit-approve-blocker.spec.ts', 'ack-opened-and-phone.spec.ts', 'fixture-steps-checked.spec.ts', 'mock-visit-object-stages.spec.ts', 'gvo-derived-defaults.spec.ts', 'promised-checks.spec.ts', 'decline-author-signature.spec.ts', 'bulletin-form-deps.spec.ts', 'date-format-contract.spec.ts', 'placement-reopen.spec.ts', 'rights-wiring.spec.ts', 'gvo-edit-rights.spec.ts', 'staff-persona-chain.spec.ts', 'audit-log-labels.spec.ts', 'forces-link-gating.spec.ts', 'gvo-catalog-refs.spec.ts', 'gvo-senior-country.spec.ts', 'api-gap-rules.spec.ts', 'allocate-vehicle-error-message.spec.ts', 'service-summary-access.spec.ts', 'service-summary.spec.ts', 'event-capabilities.spec.ts', 'global-teardown-resolution.spec.ts', 'smoke-preserve-data.spec.ts', 'hq-workspace.spec.ts', 'department-request-workspace.spec.ts', 'responsible-daily-expense.spec.ts', 'forces-workspace.spec.ts', 'chain-access-loading.spec.ts', 'daily-expense-flow-1197.spec.ts', 'workspace-desk-1199.spec.ts', 'daily-expense-personnel-1209.spec.ts', 'summary-buttons-visible-1220.spec.ts', 'summary-action-bar-1221.spec.ts', 'leadership-status-1223.spec.ts', 'service-summary-1232.spec.ts', 'full-status-dialog-1233.spec.ts', 'deviations-only-1234.spec.ts', 'sidebar-resize.spec.ts'],
  // Один воркер: обход кликает по живому стенду и меняет его состояние —
  // параллельные персоны видели бы правки друг друга.
  // Уникальность деловых дат фикстур не зависит от этого значения: global setup
  // резервирует диапазон атомарно в БД, а `e2e/business-date.ts` делит его
  // между воркерами. Один воркер здесь нужен лишь для изоляции живого стенда.
  workers: 1,
