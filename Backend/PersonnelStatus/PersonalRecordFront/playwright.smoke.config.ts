...
export default defineConfig({
  ...
  testMatch: ['smoke-buttons.spec.ts', 'objects-tabs.spec.ts', 'gvo-sections.spec.ts', 'protected-persons.spec.ts', 'legal-documents.spec.ts', 'placement-stage.spec.ts', 'closure-stage.spec.ts', 'acknowledgement-stage.spec.ts'],
