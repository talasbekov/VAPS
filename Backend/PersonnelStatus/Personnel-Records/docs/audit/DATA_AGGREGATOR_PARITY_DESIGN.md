...
* **Управление 1 (staff_units)**: Sync = 5, Async = 1. Async в текущем виде считает только прямые штатные единицы Управления 1 и упускает: другие штатные единицы, напрямую привязанные к Управлению 1, вакансию в Управлении 1, а также все штатные единицы и сотрудников в дочернем Отделе 1.
