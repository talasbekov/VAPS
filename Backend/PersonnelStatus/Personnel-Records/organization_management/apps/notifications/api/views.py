...
class NotificationViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def mark_all_read(self, request: Request) -> Response:
        ...
        половину кнопки: у ленты раздела ОМ граница уже была, у этой не было
        (прошедшее время здесь не случайно — уточнено ревью №825: «у этой нет»
        читалось как описание нынешнего состояния).
