# Generated by Django 5.1.15 on 2026-08-04 05:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duty_role_code', models.CharField(choices=[('OMD', 'ОМД'), ('ORGD', 'ОРГД'), ('HQ_DUTY', 'Дежурный по штабу'), ('OBJECT_SENIOR_DUTY', 'Старший по объекту')], max_length=50)),
                ('scope_division_id', models.IntegerField(blank=True, null=True)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user_id', 'is_active', 'starts_at', 'ends_at'], name='idx_ops_temp_duty_user')],
            },
        ),
        migrations.CreateModel(
            name='RolePermission',
