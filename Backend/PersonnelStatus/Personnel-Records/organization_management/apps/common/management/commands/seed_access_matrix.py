...
PERSONAS = [
    ...
    Persona(
        ...
        # «Сбор сил» из закрытого СНЯТ (Plane №944): раздел 7.1 спецификации
        # называет эту персону штабом сбора сил.
        "Аналитика службы, Ежедневный отчёт, Система",
    ),
    Persona(
        "dept_head",
    ...
    Persona(
        ...
        # «Сбор сил» из закрытого СНЯТ (Plane №944): штаб по разделу 7.1.
        "Аналитика службы, Ежедневный отчёт, Система",
    ),
    Persona(
        "forces_officer",
