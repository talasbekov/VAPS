...
Читать файл ЦЕЛИКОМ перед созданием эпиков или стори (`bmad-create-epics-and-stories`,
`bmad-create-story`, `bmad-sprint-planning`) — там обязательная структура стори,
критерии «стори слишком большая» и порядок декомпозиции по слоям. Правила
жёсткие: если стори не проходит критерии — дробить, а не подгонять.
